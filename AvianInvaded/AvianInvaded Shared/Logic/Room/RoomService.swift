...
final class RoomService {
    ...
    init(builder: RoomBuilder,
         ...
         currentRoomDifficulty: RoomDifficulty = .standard) {
    ...
    func buildNewRoom(portalDelegate: PortalDelegate?) -> SKNode {
        ...
        return builder.build(room: currentRoom,
    ...
    func nextRoom(direction: RoomDirection, portalDelegate: PortalDelegate?) -> SKNode {
        ...
        return builder.build(room: room,
                             availableDirections: roomRepository.currentRoomAvailableDirections,
                             portalDelegate: portalDelegate)
    }
    
    func tileSize(forScreen screenSize: CGSize) -> CGSize {
        return builder.scaleToScreen(sceneWidth: screenSize.width,
                                     imageSize: CGSize(width: currentRoom.tileSize,
